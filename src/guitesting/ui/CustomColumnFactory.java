...
/**
 * A ColumnFactory is used by JXTable to create and configure all columns. It can be set per-application (before
 ...
 * </ul>
 */
// from SwingLabs Demos(CustomColumnFactory.java)
public class CustomColumnFactory extends ColumnFactory {
   ...
   * {@inheritDoc}
   * <p>
   * Overridden to not create columns for the model columns which are listed in the excludes.
   */
  @Override
  ...
  private void configureTitle(TableColumnExt columnExt) {
    columnExt.setTitle(columnExt.getIdentifier().toString());
  }
